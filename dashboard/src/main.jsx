...
function App() {
  ...
  useEffect(() => {
    fetchReports();
    const interval = setInterval(fetchReports, 3000); // Live SOC polling
  ...
  // Removed Demo Scenario Functions
  ...
  return (
    <div className="container">
      <header>
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', background: 'rgba(255,0,0,0.1)', padding: '10px 20px', borderRadius: '20px', border: '1px solid rgba(255,0,0,0.3)' }}>
          <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: 'red', animation: 'pulse 1.5s infinite' }}></div>
          <span style={{ color: 'red', fontWeight: 'bold', fontFamily: 'var(--font-main)' }}>LIVE FEED</span>
        </div>
      </header>
