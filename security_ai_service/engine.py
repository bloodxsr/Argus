...
class SecurityDecisionEngine:
    ...
    def _apply_constraints(
        ...
        if enough_risk and enough_confidence and allowed_hour and asset_allowed and ai_allows_auto and constraints.allows_action(action) and not blocked_by_criticality:
            auto_execute = True
